                ...
                <div class="col-lg-5 text-center">
                    <div class="vertical_col">
                        ...
                        <div class="row text-center">
                            <div class="col-12">
                                <img src="Images/эконом 1.jpg" class="card-img-bottom" alt="..." />
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4 col-lg-4">
                                        <a href="Images/Slider/эконом 1.jpg">
                                            <img src="Images/Slider/эконом 1.jpg" class="d-block w-100" alt="..." />
                                            <div class="carousel-caption d-none d-md-block">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-4 col-lg-4">
                                        <a href="Images/Slider/эконом 2.jpg">
                                            <img src="Images/Slider/эконом 2.jpg" class="d-block w-100" alt="..." />
                                            <div class="carousel-caption d-none d-md-block">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-4 col-lg-4">
                                        <a href="Images/Slider/эконом 3.jpg">
                                            <img src="Images/Slider/эконом 3.jpg" class="d-block w-100" alt="..." />
                                            <div class="carousel-caption d-none d-md-block">
                                            </div>
                                        </a>
                                    </div>
